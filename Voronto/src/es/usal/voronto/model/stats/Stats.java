package es.usal.voronto.model.stats;
...
//		System.out.println(p);
	 ...
	 * @return
	 */
	public static double fwer(double alpha, Set<OntologyTerm> ot)
		{
		ArrayList<Double> pvals=new ArrayList<Double>();
		for(OntologyTerm term:ot)
	 ...
	 * @return
	 */
	public static double fdr(double alpha, Set<OntologyTerm> ot)
		{
		ArrayList<Double> pvals=new ArrayList<Double>();
		for(OntologyTerm term:ot)
			pvals.add(new Double(term.pvalue));
